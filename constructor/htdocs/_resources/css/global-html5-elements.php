...
[role="banner"] {
	height: 115px;
	margin-bottom: 3em; /* make room for absolutley position nav */
}
...
/* GRADIENTS */
.cssgradients aside {
	/*background-image:-o-linear-gradient(100% 59% 90deg,#E3E3E3, #ffffff);
	background-image:-moz-linear-gradient(100% 59% 90deg,#E3E3E3, #ffffff);
	background-image:-webkit-linear-gradient(100% 59% 90deg,#E3E3E3, #ffffff);
	...
	.cssgradients aside:hover {
		background-image:-o-linear-gradient(100% 59% 90deg,#CCCCCC, #FFFFFF);
		background-image:-moz-linear-gradient(100% 59% 90deg,#CCCCCC, #FFFFFF);
		background-image:-webkit-linear-gradient(100% 59% 90deg,#CCCCCC, #FFFFFF);
